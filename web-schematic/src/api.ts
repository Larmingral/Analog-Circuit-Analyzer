import type { AnalysisJob, DeviceDefinition, Diagnostic, SchematicDocument } from './types'
...
export async function convertSchematic(
  ...
  slicap_schematic: Record<string, unknown> | null
...
export async function importSlicapSchematic(raw: Record<string, unknown>): Promise<SchematicDocument> {
